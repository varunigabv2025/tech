...
export const api = {
  health: () => fetch(`${API}/api/health`).then(readJson),
  financierInvoices: () => fetch(`${API}/api/financier/invoices`).then(readJson),
  financierInvoice: (id) => fetch(`${API}/api/financier/invoices/${id}`).then(readJson),
  ...
  aaUnits: () => fetch(`${API}/api/aa/units`).then(readJson),
  ...
  getConsent: (id) => fetch(`${API}/api/aa/consent/${id}`).then(readJson),
